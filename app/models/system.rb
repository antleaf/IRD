...
class System < ApplicationRecord
  ...
  enum :subcategory, { unknown: 0, institutional_repository: 1, disciplinary_repository: 2, generalist_repository: 3, governmental_repository: 4, special_collection: 5, regional_repository: 6 }, prefix: true, default: :unknown, scopes: true
  ...
  Machine_readable_attributes = MachineReadableAttributeSet.new([
                                                                  ...
                                                                  MachineReadableAttribute.new(:system_category, :string, "entity.system_category", false),
                                                                  MachineReadableAttribute.new(:homepage, :string, "entity.url", true),
                                                                  MachineReadableAttribute.new(:owner_id, :string, "entity.owner.id if entity.owner", false),
                                                                  MachineReadableAttribute.new(:owner_homepage, :string, "entity.owner.website if entity.owner", false),
